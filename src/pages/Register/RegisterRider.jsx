                        ...
                        <div className="p-2 w-75">
                            <div className="row">
                                ...
                                <div className="col-3">
                                    ...
                                    <select onChange={handleInputValidation} name='vehicleType' class="form-select custom-input d-block w-100 px-3 py-2 rounded" aria-label="Default select example">
                                        <option >Car</option>
                                        <option >Bike</option>
                                    </select>
                                </div>
